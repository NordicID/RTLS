/*
 * File: app/store/DirectionOutStore.js
 *
...
Ext.define('RFID_Tag_Locator_Service.store.DirectionOutStore', {
    extend: 'Ext.data.Store',

    requires: [
        'RFID_Tag_Locator_Service.model.DirectionModel',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'DirectionOutStore',
            model: 'RFID_Tag_Locator_Service.model.DirectionModel',
            proxy: {
                type: 'memory',
                reader: {
                    type: 'json'
